...
This adaptive robot hand is designed for UAV-based autonomous package delivery problem. Therefore, the robot hand must be extremely quick (< 100 ms), lightweight (< 505 g), provide reliable grasping and enable perching for aerial platforms such as UAVs.
